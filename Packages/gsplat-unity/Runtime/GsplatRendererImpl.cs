...
namespace Gsplat
{
    public class GsplatRendererImpl
    {
        ...
        static readonly int k_splatSizeScale = Shader.PropertyToID("_SplatSizeScale");
        static readonly int k_movementSpeed = Shader.PropertyToID("_MovementSpeed");
            ...
            float movementSpeed = 0.5f, float movementScale = 0.02f, float hdrIntensityScale = 1.0f)
        {
            ...
            m_propertyBlock.SetFloat(k_movementScale, movementScale);
            m_propertyBlock.SetFloat(k_hdrIntensityScale, hdrIntensityScale);
